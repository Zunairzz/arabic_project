...
const navigation = [
    {name: 'المتحدثين', href: '/'},
    {name: 'التسجيل', href: '/'},
    {name: 'الرعايات', href: '/about'},
    {name: 'الجهات والرعاة', href: '/service'},
    {name: 'المركز الإعلامي', href: '/resume'},
    {name: 'الأجندة وورش العمل', href: '/reg1'},
                        ...
                        {navigation.map((item) => (
                            <NavItem key={item.name} className="nav-link">
                                <NavLink tag={ReactLink} to={item.href}
                                         className={`text-sm font-semibold leading-6 rounded-md px-1 py-3 transition-colors duration-300 custom-item ${
